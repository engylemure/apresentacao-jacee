...
export default class WhatIs extends React.Component {
  git = () => {
    return (
      <div>
        <Image src={require("../../assets/git.png")} margin="0px auto 40px" height="200px"/>
        <Text margin="10px 0 0" size={1} fit textColor="secondary" bold>
  ...
  github = () => {
    return (
      <div>
        <Image src={require("../../assets/github.png")} margin="0px auto 40px" height="200px"/>
        <Text margin="10px 0 0" size={1} fit textColor="secondary" bold>
