...
export default class WhatIs extends React.Component {
  docker = () => {
    return (
      <div>
        <Image src={"https://github.com/engylemure/apresentacao-jacee/raw/master/assets/docker.png"} margin="0px auto 40px" height="200px"/>
        <Text margin="10px 0 0" size={1} textSize="0.6em" textColor="black" bold>
